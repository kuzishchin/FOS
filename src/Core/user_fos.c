...
void USER_FOS_Init()
{
	 ...
	 */
	fos.sys_stack_dbg.low_sp = (uint32_t)core_stack;
	fos.sys_stack_dbg.high_sp = (uint32_t)core_stack + FOS_CORE_STACK_SIZE;
	fos.sys_stack_dbg.stack_size = FOS_CORE_STACK_SIZE;
...
{
	fos_err_t err = {0};
	err.err_code = FOS_ERROR_CORE_STACK;
	err.ext_str_ptr = "Core stack overflow\0";
